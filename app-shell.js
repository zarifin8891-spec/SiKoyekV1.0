...
function loadRBACUiLock(){if(document.getElementById('rbac-ui-loader-v1-script')){window.applyRBACUiLock?.();return}const s=document.createElement('script');s.id='rbac-ui-loader-v1-script';s.src='./rbac-ui-loader-v1.js?v=1';s.defer=true;document.head.appendChild(s)}
