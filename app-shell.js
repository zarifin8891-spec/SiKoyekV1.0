...
function loadRBACNav(){if(document.getElementById('rbac-nav-v1-script'))return;const s=document.createElement('script');s.id='rbac-nav-v1-script';s.src='./rbac-nav-v1.js?v=1';s.defer=true;document.head.appendChild(s)}
