/* Dashboard Layout V2 — stable presentation helper + compact lower-panel layout. */
(function(){
'use strict';
...
function syncLowerPanelRowHeights(){
  ...
  const grid=qs('.dashboard-lower-v3-grid')||qs('.dashboard-panels');
  if(!grid)return;
  const left=qs('.dashboard-static-health',grid), right=qs('.dashboard-static-decision',grid);
