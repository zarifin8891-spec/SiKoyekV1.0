...
(function(){
  ...
  function styles(){
    ...
    s.textContent=`
      ...
      .laporan-v3 .progress-project-filter .field label{font-size:10px;line-height:1.1;margin-bottom:5px}
      .laporan-v3 .progress-project-filter .field select{height:34px;border-radius:8px;padding:6px 8px;font-size:13px}
      ...
      .laporan-v3 .progress-project-toolbar .kpi .label{font-size:9px;line-height:1.1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
      .laporan-v3 .progress-project-toolbar .kpi .value{font-size:15px;line-height:1.05;margin-top:4px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
