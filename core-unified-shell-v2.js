...
(function(){
  ...
  async function ensureModules(){
    ...
    await loadScript('./laporan-period-fill-v2.js?v=5','__SIKOYEK_LAPORAN_PERIOD_FILL_V5__');
    ...
    await loadScript('./laporan-kinerja-proyek-v1.js?v=1','__SIKOYEK_LAPORAN_KINERJA_PROYEK_V1__');
    ...
    await loadScript('./laporan-actions-v6.js?v=3','__SIKOYEK_LAPORAN_ACTIONS_V6__');
    await loadScript('./laporan-print-rap-v3.js?v=4','__SIKOYEK_LAPORAN_PRINT_RAP_V3__');
  }
