...
(function(){
  ...
  function addStyle(){
    ...
    s.id=STYLE_ID;
    s.textContent=`
      /* Master Data CRUD dialogs: keep the existing 576px visual width,
         but remove the internal white strip and restore deliberate spacing. */
      ...
      /* The first field must visibly breathe below the colored header. */
      #modal .modalbox.${BOX_CLASS} > .field:first-of-type,
      #modal .modalbox.${BOX_CLASS} .p6-body > .field:first-of-type,
      #modal .modalbox.${BOX_CLASS} > .formgrid:first-of-type,
      #modal .modalbox.${BOX_CLASS} .p6-body > .formgrid:first-of-type{
      ...
      #modal .modalbox.${BOX_CLASS} p{
        margin:14px 20px 5px!important;
        font-size:13px!important;
      ...
      @media(max-width:620px){
        ...
        #modal .modalbox.${BOX_CLASS} .modalhead{border-radius:16px 16px 0 0!important}
      }
      @media(max-width:520px){
        #modal .modalbox.${BOX_CLASS} .modalhead{height:82px!important;min-height:82px!important;padding:15px 16px!important}
        #modal .modalbox.${BOX_CLASS} .modalhead h3{font-size:21px!important}
        #modal .modalbox.${BOX_CLASS} .modalhead button{height:40px!important;min-height:40px!important;min-width:92px!important}
        #modal .modalbox.${BOX_CLASS} .formgrid{grid-template-columns:1fr!important}
        #modal .modalbox.${BOX_CLASS} > .field,
        #modal .modalbox.${BOX_CLASS} .p6-body > .field,
        #modal .modalbox.${BOX_CLASS} > .formgrid,
        #modal .modalbox.${BOX_CLASS} .p6-body > .formgrid,
        #modal .modalbox.${BOX_CLASS} .formactions{width:calc(100% - 32px)!important;margin-left:16px!important;margin-right:16px!important}
      }
    `;
  ...
  function isMasterCrud(box){
    ...
    if(!/^(edit|hapus|tambah)\b/.test(title))return false;
  ...
  function decorate(){
    ...
    box.style.setProperty('width','576px','important');
    box.style.setProperty('min-width','576px','important');
    box.style.setProperty('max-width','576px','important');
